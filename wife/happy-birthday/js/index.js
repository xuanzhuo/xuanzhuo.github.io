...
function loop() {
    ...
    var textData1 = ctx.measureText(text1);
    var textData2 = ctx.measureText(text2);
    ctx.fillStyle = "rgba(" + parseInt(random(0, 255)) + "," + parseInt(random(0, 255)) + "," + parseInt(random(0, 255)) + ",0.3)";
    ctx.fillText(text, cw / 2 - textData.width / 2, ch / 2 - 60);
    ctx.fillText(text1, cw / 2 - textData1.width / 2, ch / 2);
    ctx.fillText(text2, cw / 2 - textData2.width / 2, ch / 2 + 60);
